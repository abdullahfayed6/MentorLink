...
class AppColors {
  ...
  // Common Colors
  static const primary = Color(0xFFA9E139);
  static const primaryVariant = Color(0xFF7CBF00);
  static const error = Color(0xFFB00020);
  static const accountHintColor = Colors.grey;
  static const primaryHeavy = Color(0xFF68940F);
  static const primaryLight = Color(0xFFEBFDC6);

  static const primaryFixed = Color(0xFFFDFFF5);
  static const onPrimaryFixed = Color(0xFF1E1E1E);

  // Text/Icon colors depending on background
